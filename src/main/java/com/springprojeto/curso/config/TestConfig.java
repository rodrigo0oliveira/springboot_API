...
import com.springprojeto.curso.entities.Payment;
...
import com.springprojeto.curso.repository.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Payment py1 = new Payment(null,Instant.parse("2019-06-20T19:53:07Z"),o1);
		o1.setPayment(py1);
